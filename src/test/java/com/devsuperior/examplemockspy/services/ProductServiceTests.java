...
public class ProductServiceTests {
	...
	@Test
	public void updateShoudlReturnProductDTOWhenIdExistsAndValidData() {
	...
	@Test void updateShouldReturnInvalidDataExceptionWhenIdExistsAndProductNameIsBlank() {
		productDTO.setName("");
	...
	@Test void updateShouldReturnInvalidDataExceptionWhenIdExistsAndProductPriceIsNegativeOrZero() {
		productDTO.setPrice(-5.0);
	...
	@Test void updateShouldReturnInvalidDataExceptionWhenIdDoesExistsAndProductNameIsBlank() {
		productDTO.setName("");
	...
	@Test void updateShouldReturnInvalidDataExceptionWhenIdDoesNotExistAndProductPriceIsNegativeOrZero() {
		productDTO.setPrice(-5.0);
